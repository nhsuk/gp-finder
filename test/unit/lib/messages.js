...
describe('messages', () => {
  describe('search information', () => {
    ...
    it('should have an outcode message when only an outcode has been passed', () => {
      const message = messages.searchInformation(false, { isOutcode: true, term: 'HG5' }, '');
    ...
    it('should have an text search message when only text has been passed', () => {
      const message = messages.searchInformation(false, undefined, 'Beech House');
    ...
    it('should have a postcode and text search message when both postcode and text has been passed', () => {
      const message = messages.searchInformation(false, { isOutcode: false, term: 'HG5 0JL' }, 'Beech House');
  ...
  describe('search help prompt', () => {
    ...
    it('should have a combined message when a postcode and name have been passed', () => {
      const message = messages.searchHelp(true, true);
  ...
  describe('no results prompt', () => {
    it('should have a GP name message when only a name has been passed', () => {
      const message = messages.noResults(undefined, 'netherthorpte');
    ...
    it('should have a combined message when a postcode and name have been passed', () => {
      const message = messages.noResults({ isOutcode: false, term: 'TR21 0HE' }, 'Dave');
    ...
    it('should have a combined message when an outcode and name have been passed', () => {
      const message = messages.noResults({ isOutcode: true, term: 'TR21' }, 'Dave');
  ...
  describe('out of England message', () => {
    it('should have a postcode message when only a postcode has been passed', () => {
      const message = messages.outOfEngland({ isOutcode: false, term: 'EH1 HE1' });
      expect(message).to.contain('The postcode \'EH1 HE1\' is not in England.');
    });

    it('should have an outcode message when only an outcode has been passed', () => {
      const message = messages.outOfEngland({ isOutcode: true, term: 'EH1' });
